    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="transaction-monitoring" className="space-y-6">
        <TabsList className="grid w-full grid-cols-2 lg:grid-cols-5 h-auto">
          <TabsTrigger value="transaction-monitoring" className="flex items-center gap-2 text-sm px-3 py-2">
            <TrendingUp className="h-4 w-4" />
            <span className="hidden sm:inline">Transaction Monitor</span>
            <span className="sm:hidden">Monitor</span>
          </TabsTrigger>
          <TabsTrigger value="compliance" className="flex items-center gap-2 text-sm px-3 py-2">
            <FileCheck className="h-4 w-4" />
            <span className="hidden sm:inline">Compliance</span>
            <span className="sm:hidden">Comply</span>
          </TabsTrigger>
          <TabsTrigger value="mfa" className="flex items-center gap-2 text-sm px-3 py-2">
            <Lock className="h-4 w-4" />
            <span className="hidden sm:inline">MFA Hub</span>
            <span className="sm:hidden">MFA</span>
          </TabsTrigger>
          <TabsTrigger value="threat-intelligence" className="flex items-center gap-2 text-sm px-3 py-2">
            <Brain className="h-4 w-4" />
            <span className="hidden sm:inline">AI Intelligence</span>
            <span className="sm:hidden">AI</span>
          </TabsTrigger>
          <TabsTrigger value="more" className="flex items-center gap-2 text-sm px-3 py-2">
            <Shield className="h-4 w-4" />
            <span className="hidden sm:inline">More Security</span>
